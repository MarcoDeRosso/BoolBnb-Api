...
class ApartmentsTableSeeder extends Seeder
{
    ...
    public function run(Faker $faker)
    {
        ...
        for($x=0; $x<17; $x++){
            ...
            $apartment->services()->attach($service1);
            $apartment->services()->attach($service2);
            $apartment->services()->attach($service3);
            $apartment->services()->attach($service4);
            $apartment->services()->attach($service5);
            $apartment->services()->attach($service6);
            $apartment->services()->attach($service7);
            $apartment->services()->attach($service8);
            $apartment->services()->attach($service9);
            $apartment->services()->attach($service10);
        }
